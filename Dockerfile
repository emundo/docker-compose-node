...
## PhantomJS
RUN curl -L https://bitbucket.org/ariya/phantomjs/downloads/phantomjs-2.1.1-linux-x86_64.tar.bz2 > phantomjs.tar.bz2 && tar xzvf phantomjs.tar.bz2 -C /usr/local/bin/ --strip-components=1
